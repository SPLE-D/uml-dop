...
import Event.checkin.core.model.invalid;
import java.lang.reflect.Constructor;
import java.util.logging.Logger;

public class CheckInFactory {
	 private static final Logger LOGGER = Logger.getLogger(CheckInFactory.class.getName());

	public CheckInFactory() {}

	 public static CheckIn createCheckIn(String fullyQualifiedName, Object ... base)
    {
        CheckIn record = null;
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (CheckIn) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of CheckIn.");
