...
public class AttendeeManagementResourceImpl extends AttendeeManagementResourceDecorator {
	protected AttendeeManagementServiceComponent recordComponent;
	private AttendeeManagementServiceImpl attendeemanagementclassattendeemanagementServiceImpl = new AttendeeManagementServiceImpl(recordComponent);

    public AttendeeManagementResourceImpl (AttendeeManagementResourceComponent record) {
        super(record);
    }
