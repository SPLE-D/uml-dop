...
public class EventCreationServiceImpl extends EventCreationServiceDecorator {
    public EventCreationServiceImpl (EventCreationServiceComponent record) {
 	...
 	public EventCreation createEventCreation(Map<String, Object> requestBody){
		...
		EventCreation eventcreationtypeeventcreationdeco = EventCreationFactory.createEventCreation("Event.eventcreation.typeeventcreation.model.EventCreationImpl", eventcreationtypeeventcreation, );
	...
	public EventCreation createEventCreation(Map<String, Object> requestBody, int id){
		...
		EventCreation eventcreationtypeeventcreation = EventCreationFactory.createEventCreation("Event.eventcreation.typeeventcreation.EventCreationImpl", eventcreation, );
